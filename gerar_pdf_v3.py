...
class PDF(FPDF):
    ...
    def footer(self):
        ...
        if os.path.exists(footer_img):
            # Subi para -45 para garantir que o 'EXTREMA/MG' não corte
...
# Conteúdo repetido para gerar o PDF final correto
...
specs_tf100 = {
    ...
    'Diferenciais': 'Resistente a respingos, teclas macias e silenciosas'
}
...
specs_ms100 = {
    ...
    'Economia': 'Sistema de desligamento automático inteligente'
}
pdf.chapter_body(specs_ms100)

pdf_output_path = r'c:\projetos\prospect-mult\teste\Ficha_Tecnica_Final_V3.pdf'
